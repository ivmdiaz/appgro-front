...
@Component({
  selector: 'app-reporte-ventas-proveedor',
  templateUrl: './reporte-ventas-proveedor.component.html',
  styleUrls: ['./reporte-ventas-proveedor.component.scss']
})
export class ReporteVentasProveedorComponent implements OnInit {
  ...
  private _createFilters(): FiltroModel[] {
    ...
    const totalVenta = new FiltroModel();
